...
* Download: [Stable version](https://github.com/Emil-18/enhanced-object-navigation/releases/download/v0.3.2/enhancedObjectNavigation-0.3.2.nvda-addon).
...
* Rushan translation has been added, thanks to @tseykovets
